        ...
        <>
            <main className="w-full mb-10">
                <div className="grid grid-cols-10">
                    ...
                    <div id="draggable-el" className="col-span-3 ml-8 mr-5 border-2 p-2 rounded-md mt-16 bg-blue-50">
                        <h1 className="font-bold text-lg text-center">Unscheduled list</h1>
                        {events.map(event => (
                        <div
                            className="fc-event border-2 p-1 m-3 w-full rounded-md ml-auto text-center bg-white"
                            title={event.title}
                            key={event.id}
                        >
                            {event.title}
